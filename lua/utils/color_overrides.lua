...
function M.black_metal_theme_overrides()
  ...
  -- Change the colorscheme syntax highlights
  -- >> Variables and constants
  vim.api.nvim_set_hl(0, '@variable', { fg = '#999999', underline = false, bold = false })
  vim.api.nvim_set_hl(0, '@constant.python', { fg = '#7c7c7c', underline = true, bold = true })
  vim.api.nvim_set_hl(0, '@constant.builtin.python', { fg = '#7c7c7c', underline = true, bold = true })
  vim.api.nvim_set_hl(0, '@boolean', { fg = '#7c7c7c', underline = true, bold = true })

  -- >> Keywords
  vim.api.nvim_set_hl(0, '@keyword.function', { fg = '#94a2b0', underline = false, bold = false })
  vim.api.nvim_set_hl(0, '@keyword.repeat', { fg = '#94a2b0', underline = false, bold = false })
  vim.api.nvim_set_hl(0, '@keyword.conditional', { fg = '#94a2b0', underline = false, bold = false })
  vim.api.nvim_set_hl(0, '@keyword.return', { fg = '#94a2b0', underline = false, bold = false })
  vim.api.nvim_set_hl(0, '@keyword.operator.python', { fg = '#9a8c7f', italic = true })
  vim.api.nvim_set_hl(0, '@keyword.import.python', { fg = '#94a2b0', italic = true })
  vim.api.nvim_set_hl(0, '@keyword.exception', { fg = '#94a2b0', bold = true })

  -- >> Functions
  vim.api.nvim_set_hl(0, '@function', { fg = '#8a7478', bold = true })
  vim.api.nvim_set_hl(0, '@function.call', { fg = '#8a7478', bold = true })
  vim.api.nvim_set_hl(0, '@method', { fg = '#8a7478', bold = true })
  vim.api.nvim_set_hl(0, '@method.call', { fg = '#8a7478', bold = true })
  vim.api.nvim_set_hl(0, '@dunder.method', { fg = '#607587', bold = true })

  -- >> Classes
  vim.api.nvim_set_hl(0, '@type', { fg = '#9287a3', bold = true }) --#82758a
  vim.api.nvim_set_hl(0, '@constructor.python', { fg = '#8b7c9c', bold = true })
  vim.api.nvim_set_hl(0, '@module.object.python', { fg = '#7c8a83', bold = true }) --92acb0
...
function M.black_metal_status_colors()
  local custom_base16 = require 'lualine.themes.base16'
  -- custom_iceberk_dark.normal.c.bg = "#080808" -- archiving bc this is my term bg
  custom_base16.normal.a.bg = '#94a2b0'
  custom_base16.inactive.b.bg = nil
  custom_base16.inactive.a.bg = nil
  custom_base16.inactive.c.bg = nil
  custom_base16.insert.a.bg = '#5f8686'
  custom_base16.visual.a.bg = '#6f9abd'
  custom_base16.replace.a.bg = '#9a8c7f'
