...
;; CUSTOM HIGHLIGHT DEFS
;; highlight dunder methods specially
((function_definition
  name: (identifier) @dunder.method
  (#match? @dunder.method "^__.+__$")))

((attribute
  object: (_) @module.object
  attribute: (identifier) @module.method
  (#match? @module.method "^[a-zA-Z_][a-zA-Z0-9_]*$")))
